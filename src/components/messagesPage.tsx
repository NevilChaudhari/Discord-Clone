    ...
    return (
        <div className="flex flex-1 flex-col text-white pb-2 w-full h-full">
            ...
            <div className="h-10 flex items-center p-3 w-full border-b border-[#303034] place-content-between">
                ...
                {selectedServer.id == 'Me' && (<div className="flex gap-5 py-1">
            ...
            <div className="flex w-full h-full">
                ...
                {/* Add Friend UI */}
                {selectedServer.id == 'Me' && friendsUI == 'add' && (<div className="flex flex-col w-full h-full">
                    {/* Messages Area */}
                ...
                {selectedServer.id == 'Me' && friendsUI == 'pending' && (<div className="flex flex-col w-full h-full">
                    {/* Messages Area */}
                ...
                {selectedServer.id == 'Me' && (<div className="flex flex-col gap-3 h-full w-[20vw] min-w-60 border-l border-[#303034] px-3 py-5">
                    {/* users template */}
